...
const AppBarContent = props => {
  ...
  return (
    <Box sx={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', py: 2, px: 2,backgroundColor: '#e4e9f5ff' }}>
      <Typography variant='fm-h7' fontSize={25} fontWeight={600} color={'#1e3a8a'}>
        {' '}
